...
```
https://proxy.scrapingpass.com:8080
```
...
```
https://YOUR-API-KEY:scrapingpass&@proxy.scrapingpass.com:8080
```
...
```
https://YOUR-API-KEY:scrapingpass&json=true@proxy.scrapingpass.com:8080
```
