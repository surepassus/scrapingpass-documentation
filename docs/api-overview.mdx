...
import HTTPRestAPICURLExample from '!!raw-loader!./snippets/api-usage-examples/http-rest-api/_short-example-curl';
import HTTPRestAPIPythonExample from '!!raw-loader!./snippets/api-usage-examples/http-rest-api/_short-example-python';
import HTTPProxyModeCURLExample from '!!raw-loader!./snippets/api-usage-examples/http-proxy-mode/_short-example-curl';
import HTTPProxyModePythonExample from '!!raw-loader!./snippets/api-usage-examples/http-proxy-mode/_short-example-python';
...
:::tip
Get started and dive directly into the [HTTP REST API](/getting-started/scrapingpass-api#http-rest-api) documentation.
:::
...
:::tip
Get started and dive directly into the [HTTP Proxy Mode](/getting-started/proxy-mode#http-proxy-mode) documentation.
:::
